...
import { InsertPersonalizedproductdetailsComponent } from '../../personalizedproductdetails/insert-personalizedproductdetails/insert-personalizedproductdetails.component';
...
export class ListProductComponent implements OnInit{
  ...
  OpenModalRegisterPersonalizedproductDetails(idProduct: number) {
    console.log('idProduct:', idProduct);
    this.matdialog.open(InsertPersonalizedproductdetailsComponent, {
      width: '80%',
      height: '85%',
