...
export class ChatConversationComponent {
  ...
  constructor(private cS: ConversationService, private route: ActivatedRoute, private location: Location ) {}
  ngOnInit(){
  ...
  goBack(): void {
    this.location.back(); // Utiliza el método back() de Location
  }
}
